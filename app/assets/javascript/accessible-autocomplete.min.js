...
accessibleAutocomplete({
  ...
  id: "my-autocomplete", // This needs to match to the <label>.
  showAllValues: true, // This shows the dropdown of options
  ...
  onConfirm: (val) => {
    ...
    console.log(
      document.getElementById("my-autocomplete").value
    );
  },
...
const people = [
  ...
  accessibleAutocomplete({
    ...
    id: "my-autocomplete-2", // This needs to match to the <label>.
    showAllValues: true, // This shows the dropdown of options
    //  dropdownArrow: () => '', // This adds an arrow at the end of the input box
    source: people,
    onConfirm: (val) => {
      ...
      console.log(
        document.getElementById("my-autocomplete-2").value
      );
    },
