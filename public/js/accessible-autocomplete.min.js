...
}); // Accessible autocomplete 1


const countries = ["Alex Church", "Ben Jones", "Cerys Adams", "Cherlize Mayans", "Craig Hinchcliffe", "Gabriel Logan", "James Chappel", "Joseph Mitchell", "Maisy Kennedy", "Maria Walker", "Rhonda Miller", "Tomas Fleetwood"];
accessibleAutocomplete({
  element: document.querySelector("#my-autocomplete-container"),
  id: "my-autocomplete",
  // This needs to match to the <label>.
  showAllValues: true,
  // This shows the dropdown of options
  //  dropdownArrow: () => '', // This adds an arrow at the end of the input box
  source: countries,
  onConfirm: val => {
    if (val != null) {
      if (val != document.getElementById("my-autocomplete").value) {
        document.getElementById("reassign-checkbox").checked = false;
      }

      document.getElementById("selected-name").innerHTML = val;
      document.getElementById("reassign-all").style.display = "block";
    } else {
      if (document.getElementById("my-autocomplete").value == '') {
        console.log('hide');
        document.getElementById("reassign-all").style.display = "none";
      }
    }

    console.log(document.getElementById("my-autocomplete").value);
  }
}); // Accessible autocomplete 2

const people = ["Alex Church", "Ben Jones", "Cerys Adams", "Cherlize Mayans", "Craig Hinchcliffe", "Gabriel Logan", "James Chappel", "Joseph Mitchell", "Maisy Kennedy", "Maria Walker", "Rhonda Miller", "Tomas Fleetwood"];
accessibleAutocomplete({
  element: document.querySelector("#my-autocomplete-container-2"),
  ...
  onConfirm: val => {
    if (val != null) {
      if (val != document.getElementById("my-autocomplete-2").value) {
        document.getElementById("reassign-checkbox-2").checked = false;
      }

      document.getElementById("selected-name-2").innerHTML = val;
      document.getElementById("reassign-all-2").style.display = "block";
    } else {
      if (document.getElementById("my-autocomplete-2").value == '') {
        console.log('hide');
        document.getElementById("reassign-all-2").style.display = "none";
      }
    }

    console.log(document.getElementById("my-autocomplete-2").value);
  }
});